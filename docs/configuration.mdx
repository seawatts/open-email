---
title: 'Configuration'
description: 'Configure Seawatts for your development environment'
---

## Configuration File

The `seawatts.config.yaml` file is the primary way to configure Seawatts. It supports the following options:
