---
title: 'Quickstart'
description: 'Get started with Seawatts in under 5 minutes'
---
...
<Steps>
  <Step title="Installation">
    Install Seawatts using your preferred package manager:
    ```bash
    # Using Homebrew
  ...
  <Step title="Initialize Project">
    ...
    - Create an `seawatts.config.yaml` file
  ...
  <Step title="Start Your Webhook">
    ...
    seawatts listen --client-id your-name
  ...
  <Step title="Configure Your Webhook Provider">
    Set up your webhook provider with the provided Seawatts URL:
    ```bash
...
### Basic Configuration
Create an `seawatts.config.yaml` file in your project root:
...
<CardGroup>
  <Card
    ...
    href="/team-setup"
  >
    Learn how to configure Seawatts for your entire team
  </Card>
  <Card
    title="Dashboard"
    icon="gauge"
  ...
  <Card
    ...
    href="/security"
  >
    Learn about Seawatts's security features and best practices
  </Card>
</CardGroup>
