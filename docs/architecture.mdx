---
title: 'Architecture'
# description: 'Understanding Seawatts\'s system design and data flow'
---

## System Overview

Seawatts consists of several key components working together to provide seamless webhook development:

<div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
  <img src="/images/arch.png" alt="Seawatts Architecture" />
</div>
...
<Steps>
  <Step title="Webhook Reception">
    - Provider sends webhook to `https://seawatts.sh/t_123?e=ENDPOINT`
