---
title: 'Contributing'
description: 'Contribute to Seawatts and run it locally'
---
...
First, clone the Seawatts repository and install dependencies:
...
```bash
npm run build --workspace=@seawatts/cli
```
...
<CardGroup>
  <Card
    ...
    href="/architecture"
  >
    Learn about Seawatts's internal architecture
  </Card>
  <Card
    title="API Reference"
    icon="code"
